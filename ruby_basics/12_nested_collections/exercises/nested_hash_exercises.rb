def find_language_information(languages, language_name)
  ...
  # }
  languages.find {|language, details| return details if language_name == language }
end
...
def find_beautiful_languages(languages)
  ...
  beautiful_languages =   languages.reduce(Hash.new()) do |acc, (key,info)|
    acc[key] =  info if info[:is_beautiful?]
    acc
  end
